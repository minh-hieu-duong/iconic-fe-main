  ...
  return (
    <footer className="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
      <div className="mx-auto max-w-screen-xl text-center">
        <a className="flex justify-center items-center text-2xl font-semibold text-gray-900 dark:text-white">
          Inconic
        </a>
        ...
        <ul className="flex flex-wrap justify-center items-center mb-6 text-gray-900 dark:text-white">
          ...
          <li>
            <a className="mr-4 hover:underline md:mr-6 ">Campaigns</a>
          </li>
          <li>
        ...
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
          © 2025 <a className="hover:underline">Inconic</a>. All Rights
          Reserved.
        </span>
      </div>
    </footer>
